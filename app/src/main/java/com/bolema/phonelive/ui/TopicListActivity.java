...
public class TopicListActivity  extends ToolBarBaseActivity {
    ...
    class   TopicTitleAdapter extends BaseAdapter {
        ...
        public View getView(final  int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                convertView = View.inflate(TopicListActivity.this,R.layout.item_hot_topic,null);
    ...
    private void onItemOnclick(int position) {
        ...
        UIHelper.showTopicLiveRoomActivity(this,mTopicTitleList.get(position));
    ...
    private void requestData() {
        PhoneLiveApi.getTopics("999","1","1",getHotTopicCallback);
    }
