...
public class PhoneRegActivity extends ToolBarBaseActivity {
    ...
    private void sendCode() {
        ...
        if(!mUserName.equals("") && mUserName.length() == 11) {
            AppContext.showToastAppMsg(PhoneRegActivity.this, getString(R.string.codehasbeensend));
            ...
            AppContext.showToastAppMsg(PhoneRegActivity.this, getString(R.string.plasecheckyounumiscorrect));
        }
