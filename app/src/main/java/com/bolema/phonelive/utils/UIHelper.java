...
public class UIHelper {
    ...
    * */
    ...
    public static void showTopicLiveRoomActivity(Context context,String topic) {
        Intent intent = new Intent(context, TopicLiveRoomActivity.class);
