        ...
        public void onResponse(String response) {
            ...
            if(null != res){
                try {
                    ...
                    int nowVersion = Integer.parseInt(AppContext.getInstance().getPackageInfo().versionName.replace(".", ""));
                    int apk_ver = Integer.parseInt(versionInfoObj.getString("apk_ver").replace(".", ""));
                    KLog.d(nowVersion+""+apk_ver);
                    if(nowVersion<apk_ver){
